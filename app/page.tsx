            ...
            <div className="lg:w-1/2 w-full">
               ...
               <div className="space-y-6 md:space-y-8">
                 <div className="flex gap-3 md:gap-4">
                   <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-indigo-100 dark:bg-indigo-900/40 text-indigo-600 dark:text-indigo-400 flex items-center justify-center font-bold text-lg md:text-xl shrink-0 transition-colors">1</div>
                   <div>
                     <h4 className="text-base md:text-xl font-semibold text-slate-800 dark:text-slate-200 mb-1 md:mb-2 transition-colors">Profil yarating</h4>
                     <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed transition-colors">GeoMind da maxsus o'quv kabinetingizga ega bo'ling. Jarayon atigi 30 soniya vaqtingizni oladi va mutlaqo bepul.</p>
                   </div>
                 </div>
                 <div className="flex gap-3 md:gap-4">
                   <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-blue-100 dark:bg-blue-900/40 text-blue-600 dark:text-blue-400 flex items-center justify-center font-bold text-lg md:text-xl shrink-0 transition-colors">2</div>
                   <div>
                     <h4 className="text-base md:text-xl font-semibold text-slate-800 dark:text-slate-200 mb-1 md:mb-2 transition-colors">AI bilan tayyorgarlik</h4>
                 ...
                 <div className="flex gap-3 md:gap-4">
                   <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-emerald-100 dark:bg-emerald-900/40 text-emerald-600 dark:text-emerald-400 flex items-center justify-center font-bold text-lg md:text-xl shrink-0 transition-colors">3</div>
                   <div>
                     <h4 className="text-base md:text-xl font-semibold text-slate-800 dark:text-slate-200 mb-1 md:mb-2 transition-colors">Katta tahlil va raqobat</h4>
